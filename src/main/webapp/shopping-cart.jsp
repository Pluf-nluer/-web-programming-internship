...
<c:set var="breadcrumbText" value="Giỏ hàng" scope="request"/>
            ...
            <div class="cart-layout">
                ...
                <div class="cart-footer">
                    ...
                    <div class="total-summary">
                        ...
                        <button type="button" class="btn-checkout disabled" id="btnCheckout">Thanh toán</button>
                    </div>
                </div>
            </div>
        </c:if>
...
<div id="search-panel">
    ...
    <div class="search-panel-content">
        ...
        <div class="search-results-list" id = "searchResultArea"></div>
    </div>
</div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if(btnCheckout){
            btnCheckout.addEventListener('click', function(e){
                ...
                alert("Vui lòng đăng nhập tài khoản thành viên để tiến hành đặt hàng và thanh toán!");
        ...
        document.querySelectorAll('.btn-qty-ajax').forEach(button=>{
            button.addEventListener('click', function (){
                ...
                }).catch(err => console.error("Lỗi cập nhật số lượng Ajax:", err));
            });
        });
                ...
                fetch('${pageContext.request.contextPath}/cart?action=removeAjax&productId=' + productId)
                    ...
                    .then(data => {
                        if(data.success){
                            ...
                            refreshChecks();
                            calculateTotal();
                            showInfo("Đã xóa thành công sản phẩm khỏi giỏ hàng");
                            const headerCount = document.getElementById('header-cart-count');
                            if(headerCount) {
                                headerCount.innerText = data.totalCartQuantity;
                            }
